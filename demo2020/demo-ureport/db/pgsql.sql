...
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."report_file_s";
CREATE SEQUENCE "public"."report_file_s"
    INCREMENT 1
    MINVALUE  1
...
;
COMMENT ON COLUMN "public"."report_file"."id" IS '主键';
COMMENT ON COLUMN "public"."report_file"."name" IS '报表名称';
COMMENT ON COLUMN "public"."report_file"."content" IS '报表内容';
COMMENT ON COLUMN "public"."report_file"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."report_file"."update_time" IS '更新时间';
COMMENT ON TABLE "public"."report_file" IS '报表信息记录表';
...
-- ----------------------------
ALTER TABLE "public"."report_file" ADD CONSTRAINT "report_file_pkey" PRIMARY KEY ("id");
