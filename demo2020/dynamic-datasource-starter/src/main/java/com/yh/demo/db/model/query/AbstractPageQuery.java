package com.yh.demo.db.model.query;
...
public abstract class AbstractPageQuery<T> implements Serializable {
    ...
    public QueryWrapper<T> initFilter(QueryWrapper<T> queryWrapper, List<String> passes) {
        ...
        for (Field declaredField : fields) {
            ...
            String sqlKey = StringUtils.camelToUnderline(strs[0]);
            ...
            if (null != queryOP) {
                switch (queryOP) {
                    ...
                    case IN:
                        ...
                        break;
                    case ORDER_BY_ASC:
                        queryWrapper.orderByAsc(StringUtils.camelToUnderline(fieldValue.toString()));
                        break;
                    case ORDER_BY_DESC:
                        queryWrapper.orderByDesc(StringUtils.camelToUnderline(fieldValue.toString()));
                        break;
                    default:
